...
We also provide a codeocean capsule (a modular container for the software environment along with code and data, that runs in a browser), allowing one-click access to guaranteed computational reproducibility of SLICES. https://codeocean.com/capsule/8643173/tree/v1
## How to use:
...
Download SLICES_docker using "docker pull xiaohang07/slices" or from https://doi.org/10.6084/m9.figshare.22707946 with pre-installed SLICES and other relevant packages. 
