...
if __name__ == '__main__':
    ...
    # train data
    train_dataset_file =  "../../../data/mp20_nonmetal/train_data_reduce_zero.csv"  # "./data/alex_crystalnn_bandgap_nonmetal_shuffled.csv"
    data_train = pd.read_csv(train_dataset_file, delimiter=',',header=0)
    slices_train = data_train.iloc[:, 0].tolist()
    props_train = data_train.iloc[:, 2].tolist()    # change to props_train = data_train.iloc[:, 1].tolist() if needed
    slices_test=[]

    # test data (optional)    
    test_dataset_file = "" #../../../data/mp20_nonmetal/test_data_reduce_zero.csv
    if os.path.exists(test_dataset_file):
        ...
        props_test = data_test.iloc[:, 2].tolist()  # change to props_train = data_train.iloc[:, 1].tolist() if needed
    ...
    tconf = TrainerConfig(max_epochs=args.max_epochs, batch_size=args.batch_size, learning_rate=args.learning_rate,
                            ...
                            final_tokens=args.max_epochs*len(slices_train)*max_len,num_workers=10, 
